...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/name-placement" element={isAuthenticated ? (projectData.pdfPages.length > 0 ? <NamePlacementEditor images={projectData.pdfPages} names={projectData.names} onNext={handleNamePlacement} onBack={() => navigate('/upload-template')} /> : null) : <Navigate to="/login" replace />} />
